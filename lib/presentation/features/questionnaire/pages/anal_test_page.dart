...
class AnalTestPage extends StatelessWidget {
  const AnalTestPage({Key? key}) : super(key: key);
              ...
              Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      'И последний, очень важный для нас, вопрос:',
                      style: TextStyle(
                          fontSize: 16,
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 25),
                    child: Text(
                      'В последние 3 месяца\nвы сдавали анализ крови на витамины?',
                      style: TextStyle(
                          fontSize: 24,
